            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <div class="dropdown">
                        ...
                        <a class="dropdown-item" href="laptop_alquiler.php" style="font-family:Sans-serif; font-size:16px;">Laptops Usadas</a>
                       </div>
                    </div>
                </li>
                <li class="nav-item">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="monitor_alquiler.php" style="font-family:Sans-serif; font-size:16px;">Monitores de
                                Segunda</a>
                        </div>
                    </div>
                </li>
